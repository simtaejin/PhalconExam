...
(9, 9, 0, 0, 'stj', 'afsdfdasf', 'fasdfasf', 1, '2018-04-05 17:39:19', '0000-00-00 00:00:00'),
(10, 10, 0, 0, 'stj', 'fasdf', 'fasdf', 0, '2018-04-05 17:41:13', '0000-00-00 00:00:00'),
(11, 11, 0, 0, 'stj', 'fasdf', 'fasdf', 1, '2018-04-05 17:41:48', '0000-00-00 00:00:00'),
(12, 12, 0, 0, 'stj', 'fasdf', 'fasdf', 1, '2018-04-05 17:41:55', '0000-00-00 00:00:00'),
(13, 13, 0, 0, 'stj', 'fasdf', 'fasdf', 4, '2018-04-05 17:42:39', '0000-00-00 00:00:00'),
(14, 13, 1, 1, 'stj', 'aaaaaaaafasdf', 'fasdfaaaaaaaa', 1, '2018-04-06 15:11:30', '0000-00-00 00:00:00');
...
CREATE TABLE IF NOT EXISTS `comment_boards` (
  `idx` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `file_boards` (
  `idx` int(11) NOT NULL AUTO_INCREMENT,
  `board_id` varchar(255) NOT NULL,
  `board_idx` int(11) DEFAULT NULL,
...
(6, 'stj', '$2y$08$NGZJYkRiNDVuNk5NY0FWdOMVe7q6ZY46pvtSCV.U1bG/u9cSWvQHm', 'stj53@nate.com', 'guest', '2017-12-07 10:21:03', '2018-02-28 16:25:34', '2018-04-26 17:20:22'),
...
CREATE TABLE IF NOT EXISTS `setup_board` (
  `idx` int(11) NOT NULL AUTO_INCREMENT,
